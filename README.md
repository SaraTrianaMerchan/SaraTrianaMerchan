...
Transitioning from hospitality to tech. Building my way into cloud computing and IoT security.

### 🔭 Currently Working On
- 🤖 Arduino Robot Dog (with my 4yo son as QA tester)
- 📚 AWS Cloud Practitioner Certification
- 🔐 CALI Security - IoT Security Framework (early stage)

### 🌱 Currently Learning
- ☁️ Cloud Computing (AWS, Azure, Oracle)
